...
public class DijkstraService {
	...
	public List<Airport> fetchShortestPath() {
		...
		airports.stream().filter(a -> a.getIata3() != null && a.getIata3().equals(origin.getIata3()))
				.collect(Collectors.toList()).stream().findAny().get().setDistance(0);
	...
	protected void visitAllAirports(List<Airport> unvisitedAirports) {
	...
	protected void compareDistanceBetween(Airport currentAirport, Airport connectedAirport) {
	...
	protected void incrementAirportsOfPath(Airport connectedAirport) {
